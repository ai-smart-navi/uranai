...
const generalMessages = [
  ...
  "落ち着いて整える力が高まっています。急がず、身の回りの小さな片づけから運気を上げていきましょう。",
...
const moneyMessages = [
  ...
  "必要なものと欲しいものを分けると、金運の流れが整います。",
  "人へのちょっとした贈り物や気配りが、巡り巡って運を運びます。",
  "貯めるよりも整える意識が合う日です。財布やアプリの整理をしてみましょう。",
  "お得情報に飛びつくより、本当に使うかどうかを基準に選ぶと吉です。",
];
