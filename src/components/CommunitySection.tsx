...
const communityFeatures: CommunityFeature[] = [
  ...
  },
  {
    ...
    description:
      "一般論だけではなく、返信しやすい一言や距離感の取り方など、参考になるやりとり例を学べます。",
    icon: BookOpen,
  },
  {
    title: "恋愛心理と行動ノウハウを限定配信",
    description:
      "相手の反応の見方、距離の詰め方、返信の考え方など、落ち着いて行動しやすくなるヒントを届けます。",
    icon: Brain,
  },
  {
          ...
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div>
              ...
              <div className="mt-4 space-y-3 text-sm font-medium leading-7 text-rosewood/75 sm:text-base sm:leading-8">
                ...
                <p>
                  返信が来ない、距離感が分からない、送ろうとして何回も文章を消す。そんな時に戻ってこられる場所を用意しました。
                </p>
                <p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-rosewood/75">
                    友達には言いづらい気持ちも、気にしすぎで終わらせず、心理整理と行動プランにつなげます。
                  </p>
                </div>
              </div>
            </div>
